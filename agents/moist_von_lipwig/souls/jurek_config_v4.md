...
- **Authoritative Maps:** You must maintain a complete, up-to-date Markdown file documenting the entire state of each specific deployment environment (`map_jureknet_coreos.md` and map_opensuse_client.md) as well as your overarching `map_jurek_domain.md`.
